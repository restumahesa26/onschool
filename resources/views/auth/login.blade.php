        ...
        <div class="signup-content">
            <form method="POST" id="signup-form" class="signup-form" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    <input type="email" class="form-input" name="email" id="email" placeholder="Masukkan Email" required />
                </div>
                <div class="form-group">
                    <input type="text" class="form-input" name="password" id="password" placeholder="Masukkan Password" required />
            ...
            <p class="loginhere">
                Belum mempunyai akun ? <a href="{{ route('register') }}" class="loginhere-link">Daftar Disini</a>
            </p>
        </div>
    </div>
</section>
